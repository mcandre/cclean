...
This is mainly useful for in-source builds. In fact, cmake recommends out of source builds. For cmake projects that use out of source builds, you can simply run `cmake -E rm -rf <build directory>`. Or, you can script more complex cleanup tasks with the cmake [-P](https://cmake.org/cmake/help/latest/manual/cmake.1.html#cmdoption-cmake-P) scripts.
